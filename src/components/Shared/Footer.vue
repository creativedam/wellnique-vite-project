<template>
  <div class="w-full">
    ...
    <section class="w-full bg-white text-slate-800 py-8">
      <div class="container mx-auto px-5 flex justify-center sm:justify-start">
        <div class="w-12 h-12 mx-auto">
          <social
            name="facebook"
            class="w-full h-full fill-sky-800 hover:fill-sky-500"
          />
        </div>
      </div>
    </section>
    ...
    <!-- FOOTER -->
    <footer class="w-full bg-sky-800 text-white py-4">
        ...
        >
          ...
          <div class="text-center md:text-left text-sm">
            <span class="font-sans font-normal block">
              All Rights Reserved. MPGB © 2023 | Disclaimer
            </span>
          </div>
